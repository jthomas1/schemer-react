...
// Prevent interacting with the sliders causing drag and drop for the whole container
    ...
    return (
        <div
            ...
            <label htmlFor={ `${ colour.id }-red` }>Red</label>
            <input
                draggable
            ...
            <label htmlFor={ `${ colour.id }-green` }>Green</label>
            <input
                draggable
                onDragStart={ suppressEvent }
                onChange={update}
            ...
            <label htmlFor={ `${ colour.id }-blue` }>Blue</label>
            <input
                draggable
                onDragStart={ suppressEvent }
                onChange={update}
